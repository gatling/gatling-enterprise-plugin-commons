...
public interface EnterpriseClient {
  ...
  /**
   * Check if client version is supported by the API
   *
  ...
  public Package getPackage(UUID pkgId) throws EnterpriseClientException;
  ...
  Package createPackage(String packageName, UUID teamId) throws EnterpriseClientException;
}
